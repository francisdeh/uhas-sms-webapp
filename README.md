...
- **Fee management** — tracking core done (fee items, learner assignment, Accountant-recorded payments with receipt uploads, balances/arrears — see Phase 5 Slice 1 in the Development Phases table). Remaining: parent-facing balance view, SMS reminders. Online pay-now was evaluated and explicitly declined (parents pay at the school, not through the app) — not on this roadmap.
