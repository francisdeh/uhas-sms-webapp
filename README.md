...
- **Fee management** — tracking core (fee items, learner assignment, Accountant-recorded payments with receipt uploads, balances/arrears) and the parent-facing balance view are both done — see Phase 5 Slices 1–2 in the Development Phases table. Remaining: SMS reminders. Online pay-now was evaluated and explicitly declined (parents pay at the school, not through the app) — not on this roadmap.
