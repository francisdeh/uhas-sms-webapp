...
- 2FA and Active Sessions are still **UI-only** — the last two Profile-page sub-features; each needs its own design (see the three shipped specs in `docs/superpowers/specs/` — save-changes, notification-preferences, self-service-deactivation — as templates).
...
| Profile pages | Save Changes + Notification prefs + self-deactivation ✅ done — 2FA, Sessions still UI-only | — | ~8 h |
...
**Recommended priority order** — Phase 3.5 is nearly done (real report-card PDFs ✅, rate-limiting audit ✅, Admin Settings page ✅, self-service deactivation ✅; two Profile-page sub-features — 2FA and Active Sessions — still open) — see the migration plan for sequencing, then **Phase 4** for the FRD requirement gaps.
...
- **Phase 3.5 — Platform completion & admin polish**: real report-card PDF rendering ✅, rate-limiting audit ✅, Admin Settings page ✅, Profile page completion (Save Changes ✅, Notifications ✅, self-deactivation ✅; 2FA, Active Sessions still open).
